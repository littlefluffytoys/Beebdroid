...
public interface LogicHandler<T> {
     ...
     * @param viewHolder
     */
    void onBindHeaderViewHolder(FilePickerFragment.HeaderViewHolder viewHolder);
     ...
     * @param data
     */
    void onBindViewHolder(FilePickerFragment.DirViewHolder viewHolder, int position, T data);
